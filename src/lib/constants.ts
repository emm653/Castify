 ...
 */
export const APP_NAME: string = 'Castify';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Users covert videos into casts.';
 ...
 */
export const APP_TAGS: string[] = ['social', 'entertainment'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Launch Castify';
